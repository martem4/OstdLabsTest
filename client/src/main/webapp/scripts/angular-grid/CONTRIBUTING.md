...
A bug is a _demonstrable problem_ that is caused by the code in the com.yoghurt.repository.
...
2. **Check if the issue has been fixed** &mdash; try to reproduce it using the
   latest `master` or development branch in the com.yoghurt.repository.

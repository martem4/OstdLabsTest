...
// Declare app level module which depends on filters, and com.yoghurt.services
var ngGridServices = angular.module('ngGrid.services', []);
var ngGridDirectives = angular.module('ngGrid.directives', []);
var ngGridFilters = angular.module('ngGrid.filters', []);
// initialization of com.yoghurt.services into the main module
...
/// <reference path="../com.yoghurt.services/SortService.js" />
...
var ngGrid = function ($scope, options, sortService, domUtilityService, $filter, $templateCache, $utils, $timeout, $parse, $http, $q) {
    ...
    self.init = function() {
        return self.initTemplates().then(function(){
            //factories and com.yoghurt.services
...
angular.module('ngGrid').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('checkboxHeaderTemplate.html',
    "<input class=\"ngSelectionHeader\" type=\"checkbox\" ng-show=\"multiSelect\" ng-com.yoghurt.model=\"allSelected\" ng-change=\"toggleSelectAll(allSelected, true)\"/>"
  );


  $templateCache.put('editableCellTemplate.html',
    "<input ng-class=\"'colt' + col.index\" ng-input=\"COL_FIELD\" ng-com.yoghurt.model=\"COL_FIELD\" />"
  );
  ...
  $templateCache.put('footerTemplate.html',
    ...
    "\n" +
    "            <select style=\"float: left;height: 27px; width: 100px\" ng-com.yoghurt.model=\"pagingOptions.pageSize\" >\r" +
    "\n" +
    ...
    "\n" +
    "            <input class=\"ngPagerCurrent\" min=\"1\" max=\"{{currentMaxPages}}\" type=\"number\" style=\"width:50px; height: 24px; margin-top: 1px; padding: 0 4px;\" ng-com.yoghurt.model=\"pagingOptions.currentPage\"/>\r" +
    "\n" +
  ...
  $templateCache.put('menuTemplate.html',
    ...
    "\n" +
    "        <input placeholder=\"{{i18n.ngSearchPlaceHolder}}\" type=\"text\" ng-com.yoghurt.model=\"filterText\"/>\r" +
    "\n" +
    "    </div>\r" +
    "\n" +
    ...
    "\n" +
    "                <label><input ng-disabled=\"col.pinned\" type=\"checkbox\" class=\"ngColListCheckbox\" ng-com.yoghurt.model=\"col.visible\"/>{{col.displayName}}</label>\r" +
    "\n" +
